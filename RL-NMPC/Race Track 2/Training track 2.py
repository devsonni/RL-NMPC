...
np.savez("2test.npz", errorarr=errorarr, w_1=w_1, w_2=w_2, erroravg=erroravg, rewardavg=rewardavg, rewardarr=rewardarr, qtable=qtable, total_episodes=total_episodes, max_step_size=max_step_size)
